...
class Viz {
  ...
  static startCountdown   = (container)       => `0 COMMAND EVENT CLOCK CLOCK_RUNNING_STATE 1 0\0`
}
class Commands {
  static countdown () {
  ...
  static foulsClock (fouls) {
    ...
    let awayBonus = ''
    for (let i = 1; i <= 5; i++) {
      if (i <= fouls[0]) homeFouls += Viz.animationStart(`HOME_FOUL_${i}_IN`)
      else homeFouls += Viz.animationStart(`HOME_FOUL_${i}_OUT`)
      if (i <= fouls[1]) awayFouls += Viz.animationStart(`AWAY_FOUL_${i + 5}_IN`)
      else awayFouls += Viz.animationStart(`AWAY_FOUL_${i + 5}_OUT`)
    }

    if (fouls[0] > 4) homeBonus = Viz.animationStart('HOME_BONUS_1_IN') +
      Viz.animationStart('HOME_BONUS_2_IN') +
      Viz.animationStart('HOME_BONUS_3_IN') +
      Viz.animationStart('HOME_BONUS_4_IN') +
      Viz.animationStart('HOME_BONUS_5_IN')
    else homeBonus = Viz.animationStart('HOME_BONUS_1_OUT') +
      Viz.animationStart('HOME_BONUS_2_OUT') +
      Viz.animationStart('HOME_BONUS_3_OUT') +
      Viz.animationStart('HOME_BONUS_4_OUT') +
      Viz.animationStart('HOME_BONUS_5_OUT')

    if (fouls[1] > 4) awayBonus = Viz.animationStart('AWAY_BONUS_6_IN') +
      Viz.animationStart('AWAY_BONUS_7_IN') +
      Viz.animationStart('AWAY_BONUS_8_IN') +
      Viz.animationStart('AWAY_BONUS_9_IN') +
      Viz.animationStart('AWAY_BONUS_10_IN')
    else awayBonus = Viz.animationStart('AWAY_BONUS_6_OUT') +
      Viz.animationStart('AWAY_BONUS_7_OUT') +
      Viz.animationStart('AWAY_BONUS_8_OUT') +
      Viz.animationStart('AWAY_BONUS_9_OUT') +
      Viz.animationStart('AWAY_BONUS_10_OUT')
  ...
  static playerSig_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('PLAYER_ID_OUT')
  }
  static playerInfo () {
  ...
  static playerInfo_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('PLAYER_ID_INFO_OUT')
  }
  static yellow () {
  ...
  static yellow_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('YELLOW_CARD_OUT')
  }
  ...
  static ballPossesion_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('BALL_POSSESION_OUT')
  }
  static doubleYellow () {
  ...
  static doubleYellow_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('DOUBLE_YELLOW_OUT')
  }
  static red () {
  ...
  static red_OUT () {
    return Viz.setScene(Viz.project, 'CLOCK') + Viz.animationStart('RED_CARD_OUT')
  }
